  ...
  return (
    <>
      ...
      <section className='mb-[4rem]' >
        ...
        <TarifsCard site="STANDARD" prix="699" description="La formule de la hess " description2="Lorem ipsum dolor sit amet consectetur. Scelerisque" bgColor="bg-[#FFF3F1]" bgButton="bg-secondary" textButton="text-[#FFFFFF] " gris="text-[#DDBCBC]" maquette="✓  Charte graphique à partir d'une maquette pré-définie" />
