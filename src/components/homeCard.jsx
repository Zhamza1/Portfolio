...
const homeCard = (props) => {
  return (
    <>
        <div className={` cursor-pointer font-medium text-[36px] w-[28%] rounded-xl h-[700px] mx-4 bg-no-repeat ${props.bgImage}`}> 
          <div className='pt-20 text-center transition transition-opacity-25 backdrop-blur-[5px] bg-[#000000] top-0 left-0 w-full h-full rounded-xl opacity-0 hover:opacity-60 transition-transform-25 hover:translate-y-[0px] translate-y-[20px] '>
            <div className='text-[#ffffff]' >{props.title}</div>
              <p className='text-[#ffffff] font-regular text-[14px] text-center ' >{props.description}</p>
