...
const footer = () => {
  return (
    <>
      <footer className=' bg-third text-white  w-full pt-10 pb-3 rounded-tr-[100px] ' >
        <section className='flex px-1 justify-around'>
        <div>
        ...
        <div>
          ...
          <p className='pt-4 font-light text-sm' >210, avenue du 8 mai 1945
